...
/* Scroll Title Begin */
var scrl = "dto's christmas letter :3 ";
function scrlsts() {
            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Giáng sinh zui zẻ nhóoo !!! dto chúc mọi người thành công trên con đường mình chọn và tiếp bước cho tương lai. Btw có mùa giáng sinh ấm áp nè. -- From dto with luv :3 --",
                        ],
                        typeSpeed: 100,
                        startDelay: 100,
                        backSpeed: 500,
